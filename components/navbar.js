...
<div id="nav-menu" class="fixed inset-0 z-[110] bg-stone-50 translate-y-full transition-transform duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] flex flex-col justify-center items-center">
    ...
    <div class="flex flex-col space-y-6 text-center">
        <a href="index.html" onclick="toggleMenu()" class="text-4xl font-serif italic text-emerald-950">Home</a>
        <a href="agraris.html" onclick="toggleMenu()" class="text-4xl font-serif italic text-emerald-950">Agraris</a>
        <a href="shop.html" onclick="toggleMenu()" class="text-4xl font-serif italic text-emerald-950">Shop</a>
...
`; // <--- INI BIANG KEROKNYA TADI (Backtick penutup)
